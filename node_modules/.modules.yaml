...
hoistedDependencies:
  ...
  '@eslint/js@8.57.1':
    '@eslint/js': public
  '@hookform/resolvers@3.10.0(react-hook-form@7.72.1(react@19.2.5))':
  ...
  anymatch@3.1.3:
    anymatch: private
  apps/backend:
    '@klaro/backend': private
  apps/frontend:
    '@klaro/frontend': private
  apps/ml:
    '@klaro/ml': private
  arg@5.0.2:
    arg: private
  ...
  eslint-config-turbo@2.9.6(eslint@8.57.1)(turbo@2.9.6):
  ...
  eslint-plugin-turbo@2.9.6(eslint@8.57.1)(turbo@2.9.6):
  ...
  packages/eslint-config:
    '@klaro/eslint-config': public
  packages/shared:
    '@klaro/shared': private
  packages/tsconfig:
    '@klaro/tsconfig': private
  packages/ui:
    '@klaro/ui': private
  parent-module@1.0.1:
...
pendingBuilds: []
prunedAt: Sat, 18 Apr 2026 20:10:25 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
